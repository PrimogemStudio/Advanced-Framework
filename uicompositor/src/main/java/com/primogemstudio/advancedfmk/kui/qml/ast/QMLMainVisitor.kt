...
class QMLMainVisitor : AbstractParseTreeVisitor<AstObject>(), QMLVisitor<AstObject> {
    val imports = AstImports()
    override fun visitProgram(ctx: QMLParser.ProgramContext?): AstObject {
        return visitChildren(ctx)
    }

    override fun visitImport_(ctx: QMLParser.Import_Context?): AstObject {
        return AstImport(
            ctx?.importIdentifier()?.JsIdentifier()?.text ?: "",
            ctx?.NumericLiteral()?.text?.toDouble() ?: 0,
            if (ctx?.AS() != null) ctx.importAlias()?.JsIdentifier()?.text else null
        ).apply { imports.imports.add(this) }
    }

    override fun visitImportIdentifier(ctx: QMLParser.ImportIdentifierContext?): AstObject {
        TODO("Not yet implemented")
    }

    override fun visitImportAlias(ctx: QMLParser.ImportAliasContext?): AstObject {
        TODO("Not yet implemented")
    }

    override fun visitRootMember(ctx: QMLParser.RootMemberContext?): AstObject {
        TODO("Not yet implemented")
    }

    override fun visitObjectDefinition(ctx: QMLParser.ObjectDefinitionContext?): AstObject {
        TODO("Not yet implemented")
    }

    override fun visitQualifiedId(ctx: QMLParser.QualifiedIdContext?): AstObject {
        TODO("Not yet implemented")
    }

    override fun visitObjectInitializer(ctx: QMLParser.ObjectInitializerContext?): AstObject {
        TODO("Not yet implemented")
    }

    override fun visitObjectMember(ctx: QMLParser.ObjectMemberContext?): AstObject {
        TODO("Not yet implemented")
    }
