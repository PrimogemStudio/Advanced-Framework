...
import com.primogemstudio.advancedfmk.simulator.objects.constraints.OBJECT_WEAKNESS
...
class EnemyObjectImpl(
    ...
    init {
        initialData[OBJECT_WEAKNESS] = initWeakness.toMutableList()
    }

    @Suppress("UNCHECKED_CAST")
    private val weakness
        get() = initialData[OBJECT_WEAKNESS] as MutableList<ObjectWeakness>
